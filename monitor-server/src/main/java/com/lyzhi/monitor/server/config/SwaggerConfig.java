...
public class SwaggerConfig {
     ...
     * Swagger要扫描的包路径
     */
    private static final String BASE_PACKAGE = "com.lyzhi.monitor.server.business";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                // 描述
                .description("“phoenix”是一个灵活可配置的开源监控平台，主要用于监控应用程序、服务器、数据库和网络，通过实时收集、汇聚和分析监控信息，实现在发现异常时立刻推送告警信息，并且提供了可视化系统进行配置、管理、查看。")
                // 构建
                .build();
    }
