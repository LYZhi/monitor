...
import com.lyzhi.monitor.common.util.ExceptionUtils;
...
import com.lyzhi.monitor.web.business.web.entity.MonitorLogOperation;
...
public class LogAspect {
     ...
     *
     */
    @Pointcut("@annotation(com.lyzhi.monitor.web.business.web.annotation.OperateLog)")
     ...
     *
     */
    @Pointcut("execution(* com.lyzhi.monitor.web.business.web.controller..*.*(..))")
