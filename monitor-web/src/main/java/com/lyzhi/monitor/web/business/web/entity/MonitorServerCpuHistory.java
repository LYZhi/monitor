...
@TableName("MONITOR_SERVER_CPU_HISTORY")
@ApiModel(value = "MonitorServerCpuHistory对象", description = "服务器CPU历史记录表")
public class MonitorServerCpuHistory implements Serializable {
