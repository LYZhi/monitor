...
@TableName("MONITOR_SERVER_DISK_HISTORY")
@ApiModel(value = "MonitorServerDiskHistory对象", description = "服务器磁盘历史记录表")
public class MonitorServerDiskHistory implements Serializable {
