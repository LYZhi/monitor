...
@TableName("MONITOR_SERVER_MEMORY_HISTORY")
@ApiModel(value = "MonitorServerMemoryHistory对象", description = "服务器内存历史记录表")
public class MonitorServerMemoryHistory implements Serializable {
