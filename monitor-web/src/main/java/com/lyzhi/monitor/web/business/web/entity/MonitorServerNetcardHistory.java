package com.lyzhi.monitor.web.business.web.entity;
...
@TableName("MONITOR_SERVER_NETCARD_HISTORY")
@ApiModel(value = "MonitorServerNetcardHistory对象", description = "服务器网卡历史记录表")
public class MonitorServerNetcardHistory implements Serializable {
