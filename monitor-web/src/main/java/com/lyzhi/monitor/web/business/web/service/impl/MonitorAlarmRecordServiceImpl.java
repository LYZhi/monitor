...
import com.lyzhi.monitor.web.business.web.dao.IMonitorAlarmRecordDao;
import com.lyzhi.monitor.web.business.web.entity.MonitorAlarmRecord;
import com.lyzhi.monitor.web.business.web.service.IMonitorAlarmRecordService;
...
import static com.lyzhi.monitor.common.util.CollectionUtils.distinctByKey;
...
public class MonitorAlarmRecordServiceImpl extends ServiceImpl<IMonitorAlarmRecordDao, MonitorAlarmRecord> implements IMonitorAlarmRecordService {
    ...
    public MonitorAlarmRecordVo getMonitorAlarmRecordDetail(Long id) {
        ...
        if (StringUtils.equals(MonitorTypeEnums.TCP4SERVICE.name(), type)) {
            monitorAlarmRecordVo.setType("TCP服务");
        }
